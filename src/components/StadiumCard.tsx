      ...
      <div className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow bg-white cursor-pointer">
        ...
        <div className="flex items-start justify-between gap-4 mb-3">
          ...
          <div className="text-right shrink-0">
            ...
            <p className="text-xs text-gray-400 mt-0.5">
              {getRatingLabel(stadium.averageRating)}
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="bg-green-50 rounded-lg p-3">
            ...
            <p className="text-xs text-green-800">{truncate(stadium.strengths[0], 80)}</p>
          </div>
          <div className="bg-amber-50 rounded-lg p-3">
            <p className="text-xs font-semibold text-amber-700 mb-1">Watch out</p>
            <p className="text-xs text-amber-800">{truncate(stadium.watchOut, 80)}</p>
          </div>
        </div>
